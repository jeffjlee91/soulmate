    ...
    return (
      <div className="container bg-color">
        <div className="d-flex justify-content-center row align-content-center full-view-height">
          ...
          <button type="button" className="btn btn-outline-secondary col-10 mt-4 btn-shadow">Sign In</button>
          <button type="button" className="btn btn-secondary col-10 mt-3 mb-3 btn-shadow">New User</button>
